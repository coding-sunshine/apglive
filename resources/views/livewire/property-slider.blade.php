...
new class extends Component {
    ...
    {
        //$this->projects = $this->fusionCrmService->getProjects($this->attr, $this->type);
    }
};
                        ...
                        <div class="property-grid-1 property-block bg-white transation-this">
                            <div
                                ...
                                <div class="cata position-absolute"><span
                                        class="sale bg-secondary text-white">For Sale</span></div>
                                <a href="#"><img src="/assets/images/property-grid-1.png" alt="Image Not Found!"></a>
                            ...
                            <div class="property_text p-4">
                                ...
                                <ul class="d-flex quantity font-fifteen">
                                    ...
                                    <li title="Area"><span><i class="fa-solid fa-vector-square"></i></span>1200 Sqft
                                    </li>
                            ...
                            <div class="d-flex align-items-center post-meta mt-2 py-3 px-4 border-top">
                                <div class="agent">
                                    <a href="#" class="d-flex text-general align-items-center"><img
                                            class="rounded-circle me-2" src="/assets/images/avatar.png"
                                            alt="avata"><span>Anil Amaravathi</span></a>
                                </div>
                    ...
                    <div class="item">
                        ...
                        <div class="property-grid-1 property-block bg-white transation-this">
                            <div
                                ...
                                <a href="#"><img src="/assets/images/property-grid-2.png" alt="Image Not Found!"></a>
                            ...
                            <div class="property_text p-4">
                                ...
                                <h5 class="listing-title"><a href="#">Luxury Condos Riverside</a></h5>
                                <span class="listing-location"><i class="fas fa-map-marker-alt"></i> 2305 Melbourne, MO 66210</span>
                                <ul class="d-flex quantity font-fifteen">
                                    <li title="Beds"><span><i class="fa-solid fa-bed"></i></span>7</li>
                                    <li title="Baths"><span><i class="fa-solid fa-shower"></i></span>5</li>
                                    <li title="Area"><span><i class="fa-solid fa-vector-square"></i></span>1200 Sqft
                    ...
                    <div class="item">
                        ...
                        <div class="property-grid-1 property-block bg-white transation-this">
                            <div
                                ...
                                <a href="#"><img src="/assets/images/property-grid-3.png" alt="Image Not Found!"></a>
                            ...
                            <div class="property_text p-4">
                                ...
                                <h5 class="listing-title"><a href="#">Gorgeous Villa Bay View</a></h5>
                                <span class="listing-location"><i class="fas fa-map-marker-alt"></i> Rhodes, Sydney, NSW, 2138</span>
                                <ul class="d-flex quantity font-fifteen">
                                    <li title="Beds"><span><i class="fa-solid fa-bed"></i></span>7</li>
                                    <li title="Baths"><span><i class="fa-solid fa-shower"></i></span>5</li>
