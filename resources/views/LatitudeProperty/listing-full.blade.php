...
@section('title') Listing Full @endsection
                    ...
                    <div class="col">
                        <nav aria-label="breadcrumb" class="mb-2">
                            <ol class="breadcrumb mb-0 bg-transparent p-0">
                                ...
                                <li class="breadcrumb-item active text-primary" aria-current="page">List View</li>
                            </ol>
                        </nav>
        ...
        <div class="full-row pt-0">
            <div class="container">
                ...
                <div class="row row-cols-1 g-4">
                    @for ($i = 0; $i < 12; $i++)
                        @include('component.property-horizontal-card')
                    @endfor
                </div>
                <div class="row">
                    <div class="col mt-5">
