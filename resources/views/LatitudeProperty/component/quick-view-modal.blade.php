                ...
                <div class="row row-cols-xl-2 row-cols-1">
                    <div class="col">
                        <div class="overflow-hidden position-relative transation thumbnail-img bg-secondary hover-img-zoom m-2">
                            ...
                            <a href="{{route('property.detail') }}"><img class="w-100" src="{{ theme_url('/images/3.png') }}" alt=""></a>
                    ...
                    <div class="col">
                        <div class="property_text transation py-3 pe-3">
                            ...
                            <div class="d-flex align-items-center post-meta mt-2 py-3 border-top">
                                <div class="agent">
                                    <a href="#" class="d-flex text-general align-items-center"><img class="rounded-circle me-2" src="{{ theme_url('images/avatar.png') }}" alt="avata"><span>Ali Tufan</span></a>
                                </div>
